...
public class OppositeOfConditionTest extends AbstractConditionTest {

    @Test
    public void should_be_met_if_condition_it_depends_on_is_not_met() {
	TestCondition isMet = new TestCondition(PieceColor.RED, null);
	isMet.isMetSpecifically = false;
	
	OppositeOfCondition cond = new OppositeOfCondition(PieceColor.BLUE, PieceColor.RED);
    ...
    @Test
    public void should_not_be_met_if_condition_it_depends_on_is_met() {
	TestCondition isMet = new TestCondition(PieceColor.RED, null);
	...
	new OppositeOfCondition(PieceColor.BLACK, null);
    }
